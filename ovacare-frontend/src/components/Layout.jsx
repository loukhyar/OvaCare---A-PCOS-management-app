      ...
      <header className="bg-pink-100 border-b border-pink-300 shadow-sm sticky top-0 z-50">
        <nav className="max-w-7xl mx-auto px-6 py-4 flex flex-col lg:flex-row justify-between items-center gap-4">
          ...
          <ul className="flex flex-col lg:flex-row flex-wrap gap-2 text-pink-900 font-medium">
            ...
            <li>
              <Link to="/about" className="px-4 py-2 rounded-full hover:bg-pink-300 hover:text-white transition">
                About
              </Link>
            </li>

            <li>
              <Link to="/symptoms" className="px-4 py-2 rounded-full hover:bg-pink-300 hover:text-white transition">
                Symptom Checker
              </Link>
            </li>
            ...
            {/* ✅ FIXED HERE */}
            <li>
              <Link to="/diet" className="px-4 py-2 rounded-full hover:bg-pink-300 hover:text-white transition">
                Nutrition Guide
              </Link>
            </li>

            <li>
              <Link to="/period" className="px-4 py-2 rounded-full hover:bg-pink-300 hover:text-white transition">
                Period Tracker
              </Link>
            </li>
